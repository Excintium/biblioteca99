...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Gestion de libros");
    ...
    private void mniListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniListarActionPerformed
        ...
        ListarLibros l = new ListarLibros();//seteamos abrir la lista al precionar el boton listar
        l.setVisible(true);//muestra la lista ListarLibros
        this.setVisible(false);//oculta el menu prinicpal cuando se abre listarLibros
